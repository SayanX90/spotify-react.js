...
const DisplayAlbum = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="mt-10 flex flex-col md:flex-row gap-8 md:items-end ">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-1">
            ...
            .1675,85 likes . 
            <b>50 songs,</b>
            .about 2 hours 40 min
          </p>
        </div>
      </div>

      <div className="grid grid-cols-3 sm:grid-cols-4 mt-10 mb-4 pl-2 text-[#bababa]">
        <p>
